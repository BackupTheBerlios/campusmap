	...
	<? }else if($aufzu =="auf"){?>	
	    ...
	    <tr>
	      ...
	      <td valign="top">
	              ...
	              if ($htmltable = Bericht::createBerichtTable($conn,$err,$sortierenach, $sortierrichtung, -1, true, $region, $groesse, $branche, $fachbereich, $studiengang, $seite, $aktuellerLink, $aufzu, $keyword)) {
	              	echo $htmltable;
	              }
