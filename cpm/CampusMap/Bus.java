...
public class Bus extends MovingObject{
	...
	public void draw(){
		...
		myDrawApplet.rotateZ(myDrawApplet.atan2(myDir.y, myDir.x));
		//body
	...
	private void setmiddlePosition() {
		myPos = FVector.add(myTailPos, FVector.multiply(FVector.subtract(myNosePos, myTailPos), 0.5f) );
	}
